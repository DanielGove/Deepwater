...
from ..metadata.discovery import feed_exists, list_segments, recommended_train_validation
...
def main(argv: list[str] | None = None) -> int:
    ...
    if sources:
        ...
        try:
            manifest = recommended_train_validation(
                args.base_path,
                feeds,
                status=args.status,
